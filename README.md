...
>  - **Elegant Minimalism:** My approach is inspired by the principles of Nordic design: purpose, simplicity, and practicality. Affective user experiences feel intuitive without drawing attention to themselves. Solutions are well design when there is nothin more to remove and (inertia/friction) is minimised.
